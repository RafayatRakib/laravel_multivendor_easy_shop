...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <form action="{{route('add.sub.cat.store')}}" method="post"  >
             @csrf
             <div class="card-body">
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                     ...
                     <div class="col-sm-9 text-secondary">
                         <input type="text" name="subcat_name" class="form-control @error('subcat_name') is-invalid @enderror" placeholder="Subcategory name" />
