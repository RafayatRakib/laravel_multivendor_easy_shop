...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <form id="contact_form" action="{{route('admin.contact.store')}}" method="post" enctype="multipart/form-data" >
             @csrf
             <div class="card-body">
                 <div class="row mb-3">
                     <div class="col-sm-3">
                     ...
                     <div class="col-sm-9 text-secondary">
                         <input type="text" id="contact_title" name="contact_title" class="form-control" placeholder="Contact title" value="{{ old('contact_title') }}" />
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <textarea  name="contact_body" class="form-control snote" id="mytextarea" cols="30" rows="10">{{ old('contact_body') }} Write here</textarea>
                ...
                <div class="row mb-3">
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-9 text-secondary">
                         <input type="submit" class="btn btn-primary px-4" value="Add Contact" />
