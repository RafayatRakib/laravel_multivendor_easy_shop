...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <form action="{{route('add.cat.store')}}" method="post" enctype="multipart/form-data" >
             @csrf
             <div class="card-body">
                 <div class="row mb-3">
                     <div class="col-sm-3">
                     ...
                     <div class="col-sm-9 text-secondary">
                         <input type="text" name="cat_name" class="form-control @error('cat_name') is-invalid @enderror" placeholder="Category name" />
