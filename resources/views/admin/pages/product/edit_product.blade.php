...
<div class="page-content">
   ...
   <div class="card">
      <div class="card-body p-4">
         ...
         <hr/>
         <form action="{{route('admin.update.product',$product->id)}}" id="myForm" method="post" enctype="multipart/form-data">
          @csrf
                  ...
                  <div class="border border-3 p-4 rounded">
                     <div class="row g-3">
                        ...
                        <div class="col-12">
                           ...
                           <select name="vendor" class="form-select form-control  " id="inputCollection">
   ...
   <div class="card">
      <div class="card-body p-4">
         ...
         <div class="form-body mt-4">
            <div class="row">
               <form action="{{route('admin.update.product.cover',$product->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
               <div class="col-lg-8">
                     <div class="row mb-3">
                        <div class="col-sm-3">
      ...
      <div class="card-body p-4">
         ...
         <div class="table-responsive">
            <table  class="table  table-bordered" style="width:100%">
                ...
                <tbody>
                  <form action="{{route('admin.update.product.multi.image')}}" method="post" enctype="multipart/form-data">
                     @csrf
            ...
            <div class="my-3">
            <form action="{{route('admin.delte.all.image')}}" method="post" enctype="multipart/form-data">
               @csrf
            <div class="row">
               <div class="col-md-4">
                  <div class="form-check">
            ...
            {{-- Add some image part --}}
            <form action="{{route('admin.insert.multi.image')}}" method="post">
               @csrf
            <div class="mb-3">
               <input type="hidden" name="id" value="{{$product->id}}">
         ...
         <form action="{{route('admin.insert.multi.image')}}" method="post" enctype="multipart/form-data">
            @csrf
         <div class="mb-3">
            <input type="hidden" name="id" value="{{$product->id}}">
