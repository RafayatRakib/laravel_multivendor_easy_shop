...
<div class="page-content">
   ...
   <div class="card">
      <div class="card-body p-4">
         ...
         <hr/>
         <form action="{{route('admin.store.product')}}" id="myForm" method="post" enctype="multipart/form-data">
          @csrf
                  ...
                  <div class="border border-3 p-4 rounded">
                     <div class="row g-3">
                        ...
                        <div class="col-12">
                           ...
                           <select name="vendor" class="form-select form-control  @error('vendor') is-invalid @enderror" id="inputCollection">
                              <option selected disabled>select vendor</option>
                              @foreach ($vendor as $item)
                              <option value="{{$item->id}}">{{$item->name}}</option>
                              @endforeach
                           </select>
                        @error('vendor')  <div class="text-danger">{{$message}}</div> @enderror
