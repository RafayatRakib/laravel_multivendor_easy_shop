...
@section('title', 'Easy Shop | '.$subcat->subcat_name)
@section('content')
    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-5">
                    <h1 class="mb-15"> {{$subcat->subcat_name}} </h1>
                    @php
                        $cat =  App\Models\Category::findOrFail($subcat->cat_id);
                    @endphp
                    <div class="breadcrumb">
                        <a href="{{url('/')}}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a><span></span> <a href="{{url('/product/category/'.$cat->id.'/'.$cat->cat_slug)}}">{{$cat->cat_name}} </a>
                        <span></span><a href="{{url('/product/subcategory/'.$subcat->id.'/'.$subcat->subcat_slug)}}">{{$subcat->subcat_name}}</a>
                    </div>
                </div>
    ...
    <div class="row flex-row-reverse">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    @php
                        $subcat = App\Models\Subcategory::where('id','!=',$subcat->id)->inRandomOrder()->limit(5)->get();
                    @endphp
                        @foreach($subcat as $subcat)
                    <li>
                        @php
                            $product =  App\Models\Product::where('sub_cat_id',$subcat->id)->get();
                        @endphp
                        <a href="{{url('/product/subcategory/'.$subcat->id.'/'.$subcat->subcat_slug)}}"> <img src="{{asset($subcat->cat_image)}}" alt="" />{{$subcat->subcat_name}}</a><span class="count">{{count($product)}}</span>
                    </li>
