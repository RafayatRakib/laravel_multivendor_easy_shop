                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="attr-detail attr-size mb-30" id="sizeArea">
                                    ...
                                    <select class="form-control unicase-form-control" id="selecteSize" name="selecteSize"> </select>
                              ...
                              <div class="col-md-6">
                                 <div class="attr-detail attr-size mb-30" id="colorArea">
                                    ...
                                    <select class="form-control unicase-form-control" id="selecteColor" name="selecteColor"> </select>
                                </div> 
                              </div>
                           </div>
