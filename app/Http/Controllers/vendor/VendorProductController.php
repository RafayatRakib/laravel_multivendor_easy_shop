...
class VendorProductController extends Controller
{
    public function AllProduct(){
        ...
        $product = Product::where('vendor_id',$id)->latest()->get();
         return view('vendor.pages.product.all_product', compact('product'));
     }//END METHOD
     ...
     public function AddProduct(){
         ...
         return view('vendor.pages.product.add_product', compact('product','cat','subcat','brand','vendor'));
     ...
     public function StoreProduct(Request $request){
         ...
         if($request->file('product_cover')){
             ...
             Image::make($file)->resize(110,110)->save('public/uploads/product/cover/'.$newName);
         ...
         if($request->file('multi_img')){
             ...
             foreach($img as $file){
                 $newName = md5(uniqid(rand(), true)).'.'.$file->getClientOriginalExtension();
                 Image::make($file)->resize(110,110)->save('public/uploads/product/Image/'.$newName);
             ...
             return redirect()->route('vendor.all.product')->with($msg);
     }  //END METHOD
 ...
 public function ProductEdit($id){
     ...
     $brand = Brand::latest()->get();
     return view('vendor.pages.product.edit_product', compact('product','cat','subcat','brand','vendor','multi_img'));
 }// END METHOD
 ...
 public function ProductCoverUpdate(Request $request, $id){
     ...
     if($request->file('product_cover')){
         ...
         $file = $request->file('product_cover');
         $newName = md5(uniqid(rand(), true)).'.'.$file->getClientOriginalExtension();
         Image::make($file)->resize(400,400)->save('public/uploads/product/cover/'.$newName);
         $cover_url = 'public/uploads/product/cover/'.$newName;
     }
     Product::findOrfail($id)->update([
         'product_cover' => $cover_url,
